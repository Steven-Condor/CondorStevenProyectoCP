...
map_modules:
	...
	/* module_uuid: ec516611-0374-4279-9ec8-36d5f8add7be */
	.byte	0x11, 0x66, 0x51, 0xec, 0x74, 0x03, 0x79, 0x42, 0x9e, 0xc8, 0x36, 0xd5, 0xf8, 0xad, 0xd7, 0xbe
	/* entry_count */
	.word	9
	/* duplicate_count */
	.word	0
	...
	/* module_uuid: 3d946639-6056-46a9-9a3f-ae09ea963bd0 */
	.byte	0x39, 0x66, 0x94, 0x3d, 0x56, 0x60, 0xa9, 0x46, 0x9a, 0x3f, 0xae, 0x09, 0xea, 0x96, 0x3b, 0xd0
	/* entry_count */
	.word	579
	/* duplicate_count */
	.word	90
	...
	/* module_uuid: c151e742-9966-4f1b-8df2-197a97f2e8ed */
	.byte	0x42, 0xe7, 0x51, 0xc1, 0x66, 0x99, 0x1b, 0x4f, 0x8d, 0xf2, 0x19, 0x7a, 0x97, 0xf2, 0xe8, 0xed
	/* entry_count */
	.word	11
	/* duplicate_count */
	.word	2
	...
	/* module_uuid: 331ada61-27bb-4016-921b-31fa03c6f044 */
	.byte	0x61, 0xda, 0x1a, 0x33, 0xbb, 0x27, 0x16, 0x40, 0x92, 0x1b, 0x31, 0xfa, 0x03, 0xc6, 0xf0, 0x44
	/* entry_count */
	.word	33
	/* duplicate_count */
	.word	5
	...
	/* module_uuid: 65eaad97-cfcc-4efe-8f9b-1bcc93b5673c */
	.byte	0x97, 0xad, 0xea, 0x65, 0xcc, 0xcf, 0xfe, 0x4e, 0x8f, 0x9b, 0x1b, 0xcc, 0x93, 0xb5, 0x67, 0x3c
	/* entry_count */
	.word	3
	/* duplicate_count */
	.word	0
	...
	/* duplicate_map */
	.xword	0
	/* assembly_name: AllyContratista.Android */
	...
	/* module_uuid: d6264bc0-c53f-4f04-b596-9ce227d31548 */
	.byte	0xc0, 0x4b, 0x26, 0xd6, 0x3f, 0xc5, 0x04, 0x4f, 0xb5, 0x96, 0x9c, 0xe2, 0x27, 0xd3, 0x15, 0x48
	/* entry_count */
	.word	1
	/* duplicate_count */
	.word	0
	...
	/* duplicate_map */
	.xword	0
	/* assembly_name: Xamarin.Plugin.Calendar */
	...
	/* module_uuid: 1c7d7ee7-91f3-4475-afb8-0a0cd4a769f5 */
	.byte	0xe7, 0x7e, 0x7d, 0x1c, 0xf3, 0x91, 0x75, 0x44, 0xaf, 0xb8, 0x0a, 0x0c, 0xd4, 0xa7, 0x69, 0xf5
	/* entry_count */
	.word	3
	/* duplicate_count */
	.word	0
	...
	/* module_uuid: 9a2e99ed-6fff-4efe-a755-161ca60e031a */
	.byte	0xed, 0x99, 0x2e, 0x9a, 0xff, 0x6f, 0xfe, 0x4e, 0xa7, 0x55, 0x16, 0x1c, 0xa6, 0x0e, 0x03, 0x1a
	/* entry_count */
	.word	8
	/* duplicate_count */
	.word	2
...
map_java:
	...
	.word	33554438
	/* java_name */
	.ascii	"crc646e953e4bea3536c0/MyCustomeRenderer"
	.zero	78
	.zero	1
	...
	.word	33554434
	/* java_name */
	.ascii	"crc64ecc2d44582227e0c/MainActivity"
	.zero	83
	.zero	1
	...
	.word	33554439
	/* java_name */
	.ascii	"crc64eda7b033bf07d121/GoogleActivity"
	.zero	81
	.zero	1
	...
	.word	33554450
	/* java_name */
	.ascii	"crc64ef2c1b6c62d0b349/SwipeAwareContainerRenderer"
	.zero	68
	.zero	1
